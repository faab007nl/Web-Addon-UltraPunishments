...
<head>
    ...
    <link rel="stylesheet" href="assets/css/styles.min.css">
    <title>UltraPunishments - <?php echo $lang->punishments; ?></title>
                ...
                <div>
                    <div class="nav">
                        <ul class="tab tab-block">
                            <li class="tab-item active" style="border-bottom: solid 1px #f77727;color:#f77727;"><a class="link" href="./punishments" style="color:#f77727;"><?php echo $lang->punishments; ?></a></li>
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="table-header-cell"><?php echo $lang->expiry; ?></th>
                                        <th class="table-header-cell"><?php echo $lang->duration; ?></th>
                                        <th class="table-header-cell"><?php echo $lang->reason; ?></th>
                                        <th class="table-header-cell"><?php echo $lang->type; ?></th>
                                    </tr>
                                </thead>
                                <tbody class="table-body">
                                    <?php
                                        $pdoResult1 = $PDOdb->prepare("SELECT * FROM UltraPunishments_Punishments ORDER BY UltraPunishments_Punishments.key DESC");
                                        ...
                                        if($pdoExec1){
                                            while($row1 = $pdoResult1->fetch(PDO::FETCH_ASSOC)){
                                                ...
                                                if($expiry == '0'){
                                                    ...
                                                    $expiry = date("Y-m-d h:i:s A", $expiry / 1000);
                                                }
                                                ...
                                                echo '
                                                    <tr>
                                                        ...
                                                        <td class="table-cell">'.$data['reason'].'</td>
                                                        <td class="table-cell">'.$data['type'].'</td>
                                                    </tr>
                                                ';
                                            }
                                        }else{
