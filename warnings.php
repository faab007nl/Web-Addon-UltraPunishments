...
<head>
    ...
    <link rel="stylesheet" href="assets/css/styles.min.css">
    <title>UltraPunishments - <?php echo $lang->warnings; ?></title>
                ...
                <div>
                    <div class="nav">
                        <ul class="tab tab-block">
                            ...
                            <li class="tab-item active" style="border-bottom: solid 1px #f77727;"><a style="color:#f77727;" class="link" href="./warnings"><?php echo $lang->warnings; ?></a></li>
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="table-header-cell"><?php echo $lang->seen; ?></th>
                                        <th class="table-header-cell"><?php echo $lang->kick; ?></th>
                                    </tr>
                                </thead>
                                <tbody class="table-body">
                                    <?php
										$pdoResult1 = $PDOdb->prepare("SELECT * FROM UltraPunishments_Warnings");
										...
										if($pdoExec1){
											while($row1 = $pdoResult1->fetch(PDO::FETCH_ASSOC)){
												...
												$pdoResult2 = $PDOdb->prepare("SELECT * FROM UltraPunishments_PlayerIndexes ORDER BY UltraPunishments_PlayerIndexes.key DESC");
												...
												<tr>
                                                    ...
                                                    <td class="table-cell">'.$seen.'</td>
                                                    <td class="table-cell">'.$kick.'</td>
                                                </tr>
												';
											}
										}else{
